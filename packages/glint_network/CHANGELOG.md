...
- Attaching to a VM service that never answers the WebSocket upgrade (a suspended or backgrounded app) now fails after 8 seconds instead of waiting forever.
