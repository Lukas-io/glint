...
Future<void> runUsage(List<String> args) async {
  ...
  if (parsed['help'] == true) {
    ...
    io.stdout.writeln(
      ...
      '(ok/error/empty), a duration, and a result size. Nothing is shipped '
      'anywhere. Opt out with FLUTTER_NETWORK_MCP_NO_USAGE=true (or the '
      'broader FLUTTER_NETWORK_MCP_NO_TELEMETRY=true).',
    );
    return;
  }
