...
import 'package:glint/src/version.dart';
import 'package:test/test.dart';

import '../tool/release.dart';

void main() {
  test('pubspec.yaml and glintVersion agree', () {
    expect(currentVersion(), glintVersion);
    expect(File('pubspec.yaml').readAsStringSync(), contains('version: $glintVersion'));
  });
